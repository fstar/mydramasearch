...
class Episode(db.Model):
    ...
    create_time = db.Column("create_time", DateTime, nullable=False, default=datetime.now, doc="创建时间")
...
class Video(db.Model):
    ...
    create_time = db.Column("create_time", DateTime, nullable=False, default=datetime.now,
